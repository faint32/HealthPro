...
public class MyFansListActivity extends BaseInfoListActivity implements
	...
	protected void onInitActionBar() {
		...
		getSupportActionBar().setTitle(R.string.new_follow);
	}

	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		// TODO Auto-generated method stub
		getMenuInflater().inflate(R.menu.my_fans, menu);
	...
	public void initData() {
		...
		uid = WyyApplication.getInfo().getId();
		onReshList();
	}
