...
public class FollowUserActivity extends BaseInfoListActivity implements
	...
	public void initData() {
		// TODO Auto-generated method stub
		super.initData();
		adapter = new UserInfoAdapter(followList, context);
	...
	protected void onReshList() {
		...
		HealthHttpClient.followUserList(WyyApplication.getInfo().getId(), uid,
	...
	public void follow(int position) {
		...
		if (personalInfo != null && !personalInfo.isIsfollow()
			...
			followList.get(position).setIsfollow(true);
			adapter.notifyDataSetChanged();
		}
	}
