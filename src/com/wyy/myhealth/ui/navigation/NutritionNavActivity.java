...
public class NutritionNavActivity extends Activity {

	private static final String TAG=NutritionNavActivity.class.getSimpleName();
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_nutri_nav);
		findViewById(R.id.nutri_nav).setOnClickListener(new OnClickListener() {
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
		setIsFristUse(NutritionNavActivity.this, false);
	}
