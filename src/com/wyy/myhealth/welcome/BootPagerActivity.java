...
public class BootPagerActivity extends Activity implements ActivityInterface{
	...
	public void initView() {
		...
		oneTextView=(TextView)view0.findViewById(R.id.boot_txt_content);
		twoTextView=(TextView)view1.findViewById(R.id.boot_txt_content);
		thrTextView=(TextView)view2.findViewById(R.id.boot_txt_content);
		
		p0.setImageResource(R.drawable.boot1);
		p1.setImageResource(R.drawable.boot2);
		p2.setImageResource(R.drawable.boot3);
		
		enter=(TextView)view2.findViewById(R.id.enter_btn);
	...
	private OnPageChangeListener listener=new OnPageChangeListener() {
		...
		public void onPageSelected(int arg0) {
			...
			for (int i = 0; i < imageViews.length; i++) {
				imageViews[arg0]
						.setBackgroundResource(R.drawable.icon_done);
				if (arg0 != i) {
					imageViews[i]
							.setBackgroundResource(R.drawable.icon_next);
				}
			}
		}
